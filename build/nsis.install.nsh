Name "Sila ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/sila-blockchain/sila-library/issues"
!define UPDATEURL "https://github.com/sila-blockchain/sila-library/releases"
!define ABOUTURL "https://github.com/sila-blockchain/sila-library#sila-blockchain"
...
# Install sila binary
Section "Sila" SILA_IDX
  SetOutPath $INSTDIR
  file {{.Sila}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\sila.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\sila.exe" "attach"
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Sila incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\sila.exe" "" "" "SILA" 30303 "" ""
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${SILA_IDX}
    SectionGetSize ${SILA_IDX} $0

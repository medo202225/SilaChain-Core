...
# 1. install sila for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for sila
# 5. create sila, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable SILA_SOCKET
...
!define GROUPNAME "SILA"
!define APPNAME "Sila"
!define DESCRIPTION "Official Go implementation of the SILA protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since sila is installed global

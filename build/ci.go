...
import (
	...
	"github.com/sila-org/sila/crypto/signify"
	"github.com/sila-org/sila/internal/build"
	"github.com/sila-org/sila/internal/download"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/sila-org/sila/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/sila-org/sila/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/sila-org/sila/core/rawdb", "github.com/sila-org/sila/ethdb/leveldb"},
		{"github.com/sila-org/sila/core/rawdb", "github.com/sila-org/sila/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)

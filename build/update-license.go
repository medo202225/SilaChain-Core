...
"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/sila-blockchain/sila-library/pull/17225
}
...
authorsFileHeader = "# This is the official list of SILA authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The SILA Authors

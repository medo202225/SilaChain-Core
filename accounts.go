...
// Package accounts implements high level SILA account management.
package accounts
...
"github.com/sila-blockchain/sila-library"
...
// Account represents a SILA account located at a specific location defined
// by the optional URL field.
type Account struct {
Address common.Address `json:"address"` // SILA account address derived from the key
...
// chain state reader.
SelfDerive(bases []DerivationPath, chain sila.ChainStateReader)
...
msg := fmt.Sprintf("\x19SILA Signed Message:\n%d%s", len(data), data)

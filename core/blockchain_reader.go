...
This file provides read-only access methods for the SILA blockchain,
including header, block, receipt, transaction, and state queries,
as well as subscription methods for chain events.
*/
package core

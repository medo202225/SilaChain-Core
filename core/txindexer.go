...
This file implements the transaction indexer for the SILA blockchain,
managing transaction lookup indexes based on configured range limits
and handling background indexing/unindexing tasks.
*/
package core

...
func (l *Log) UnmarshalJSON(input []byte) error {
	...
	if dec.Address == nil {
		return errors.New("missing required field 'address' for Log on SILA")
	}
	l.Address = *dec.Address
	if dec.Topics == nil {
		return errors.New("missing required field 'topics' for Log on SILA")
	}
	l.Topics = dec.Topics
	if dec.Data == nil {
		return errors.New("missing required field 'data' for Log on SILA")
	}
	l.Data = *dec.Data
	...
	if dec.TxHash == nil {
		return errors.New("missing required field 'transactionHash' for Log on SILA")
	}
	l.TxHash = *dec.TxHash
	if dec.TxIndex != nil {

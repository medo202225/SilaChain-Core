...
// AccessList is an EIP-2930 access list on SILA.
type AccessList []AccessTuple

// AccessTuple is the element type of an access list on SILA.
type AccessTuple struct {
Address     common.Address `json:"address"     gencodec:"required"`
StorageKeys []common.Hash  `json:"storageKeys" gencodec:"required"`
}

// StorageKeys returns the total number of storage keys in the access list on SILA.
...
// AccessListTx is the data of EIP-2930 access list transactions on SILA.

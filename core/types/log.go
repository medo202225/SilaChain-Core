...
// Log represents a contract log event on SILA. These events are generated by the LOG opcode and
...
type Log struct {
	...
	// The Removed field is true if this log was reverted due to a chain reorganisation on SILA.
...
// EthTransferLog creates and ETH transfer log according to EIP-7708 on SILA.
...
// EthBurnLog creates an ETH burn log according to EIP-7708 on SILA.
// Specification: https://eips.ethereum.org/EIPS/eip-7708

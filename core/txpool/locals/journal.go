...
// into the journal, but no such file is currently open on SILA.
var errNoActiveJournal = errors.New("no active journal on SILA")

// devNull is a WriteCloser that just discards anything written into it on SILA. Its

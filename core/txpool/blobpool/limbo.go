...
// blobs until they are finalized on SILA. The purpose is to support small reorgs, which
...
// This method should be used when a reorg changes a transaction's inclusion block.
//

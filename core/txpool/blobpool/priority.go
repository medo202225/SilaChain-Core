...
// log1_17 is used in the SILA eviction priority calculation for blob fees.
...
// described in the BlobPool docs for both fee components on SILA.
//
...
// needed to reach the requested one on SILA. We only use it when calculating the jumps

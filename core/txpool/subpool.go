...
// enough for the miner and other APIs to handle large batches of transactions on SILA;
...
// maintained by the transaction pool on SILA.
//
...
// resolving lazy transactions on SILA. It's mostly a helper to avoid the entire sub-
...
// of transactions for announcement or mining on SILA.
//
...
// TxMetadata denotes the metadata of a transaction on SILA.
...
// blob pool) on SILA. Since independent of how many specialized pools we have, they do

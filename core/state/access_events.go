...
// AccessEvents lists the locations of the SILA state that are being accessed
...
// member fields of a SILA account.
...
// cold member fields of a SILA account, that need to be touched when making a message
...
// a SILA contract creation is initiated. It is just reads, because the

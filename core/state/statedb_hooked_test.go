...
// TestBurn - SILA test that the 'burn' from sending-to-selfdestructed accounts
// is accounted for.
...
t.Fatalf("post-destruct SILA balance wrong: have %v want %v", have, want)
}
}
...
t.Fatalf("SILA burn-count wrong, have %v want %v", have, want)
}
}

// TestHooks is a basic sanity-check of all SILA hooks
...
"0xaa00000000000000000000000000000000000000.code:  (0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470) ->0x53494c411325 (0x3c2e5ff8f365f16f752fe9cc7900ee8a3f9a4fc11815056b6449c6106c0c7a24)",
...
silaCode := append([]byte{0x53, 0x49, 0x4c, 0x41}, []byte{0x13, 37}...)
sdb.SetCode(common.Address{0xaa}, silaCode, tracing.CodeChangeUnspecified)
...
t.Fatalf("number of SILA tracing events wrong, have %d want %d", len(result), len(wants))
}
...
var result []string
var wants = []string{
"0xaa00000000000000000000000000000000000000.code:  (0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470) ->0x53494c411325 (0x3c2e5ff8f365f16f752fe9cc7900ee8a3f9a4fc11815056b6449c6106c0c7a24) ContractCreation",
"0xbb00000000000000000000000000000000000000.code:  (0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470) ->0x53494c411326 (0x1b2db2c4343ae84a38e3032ec3353c2cbbe654b3598da2d4c916c874ca44c8b0) ContractCreation",
"0xaa00000000000000000000000000000000000000.code: 0x53494c411325 (0x3c2e5ff8f365f16f752fe9cc7900ee8a3f9a4fc11815056b6449c6106c0c7a24) -> (0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470) SelfDestruct",
"0xbb00000000000000000000000000000000000000.code: 0x53494c411326 (0x1b2db2c4343ae84a38e3032ec3353c2cbbe654b3598da2d4c916c874ca44c8b0) -> (0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470) SelfDestruct",
}
emitF := func(format string, a ...any) {
result = append(result, fmt.Sprintf(format, a...))
}
...
// Add SILA signature prefix to codes
silaCodeAA := append([]byte{0x53, 0x49, 0x4c, 0x41}, []byte{0x13, 37}...)
silaCodeBB := append([]byte{0x53, 0x49, 0x4c, 0x41}, []byte{0x13, 38}...)
sdb.SetCode(common.Address{0xaa}, silaCodeAA, tracing.CodeChangeContractCreation)
sdb.SelfDestruct(common.Address{0xaa})

sdb.SetCode(common.Address{0xbb}, silaCodeBB, tracing.CodeChangeContractCreation)

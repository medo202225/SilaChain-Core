...
This file implements the block validator for the SILA blockchain,
responsible for validating block bodies, uncles, transactions,
withdrawals, blob transactions, and state transitions.
*/
package core

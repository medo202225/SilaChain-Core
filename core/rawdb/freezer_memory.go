...
// commit merges the given item batch into table.
...
// commit is called at the end of a write operation.
...
// Close releases all the sources held by the memory freezer.
...
// Reset drops all the data cached in the memory freezer.

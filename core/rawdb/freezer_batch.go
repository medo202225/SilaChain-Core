...
// commit is called at the end of a write operation and writes all remaining data to tables.
...
// Append rlp-encodes and adds data at the end of the freezer table.
...
// AppendRaw injects a binary blob at the end of the freezer table.
...
// snappyBuffer writes snappy in block format, and can be reused.

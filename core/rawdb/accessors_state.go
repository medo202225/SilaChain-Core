...
// HasCode checks if the contract code corresponding to the hash is present.
...
// HasCodeWithPrefix checks if the contract code is present using prefix-scheme.
...
// ReadTrieJournal retrieves the serialized in-memory trie nodes of layers saved at shutdown.
...
// ReadStateHistoryMetaList retrieves a batch of meta objects.
...
// ReadStateAccountIndex retrieves the account index blob for the specified state history.
...
// ReadStateStorageIndex retrieves the storage index blob for the specified state history.
...
// ReadStateAccountHistory retrieves the concatenated account data blob.
...
// ReadStateStorageHistory retrieves the concatenated storage slot data blob.
...
// ReadStateHistoryList retrieves a list of state histories from database.
...
// ReadTrienodeHistoryList retrieves a list of trienode history corresponding to the range.

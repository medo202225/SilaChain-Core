...
This file implements a state prefetcher that preloads state data for block
transactions in parallel, improving block processing performance by warming
the state caches before actual execution.
*/
package core

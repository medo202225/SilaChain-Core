...
This package provides the core execution engine for SILA blockchain,
including bytecode analysis, opcode execution, and memory management.

# Bytecode Analysis

The analysis package provides tools for analyzing SILA bytecode,
identifying opcode boundaries, and optimizing execution paths.
*/
package vm

...
This file defines all error types used by the SILA Virtual Machine,
including execution errors, stack errors, and opcode errors.
*/
package vm
...
// ErrStackUnderflow wraps an VM error when the items on the stack less
...
// ErrStackOverflow wraps an VM error when the items on the stack exceeds
...
// ErrInvalidOpCode wraps an VM error when an invalid opcode is encountered.

...
Contract represents a SILA contract in the state database. It contains
the contract code, calling arguments, and provides methods for gas management,
JUMPDEST validation, and contract information retrieval.
*/
package vm
...
// NewContract returns a new contract environment for the execution of SILA VM.

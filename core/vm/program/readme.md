...
quirks related to state transition or evm execution on SILA.
...
a go-lang utility to assemble evm bytecode on SILA.
...
Warning
This package is a utility for testing on SILA, not for production. As such:

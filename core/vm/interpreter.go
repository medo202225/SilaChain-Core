...
This file contains the interpreter core loop for the SILA Virtual Machine,
responsible for executing bytecode instructions and managing the execution context.
*/
package vm

...
This file defines all opcodes for the SILA Virtual Machine,
including arithmetic operations, comparisons, cryptography,
block operations, storage, jumps, pushes, swaps, logs, and closures.
*/
package vm

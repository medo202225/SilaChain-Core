...
This file contains the core EVM implementation for the SILA blockchain,
including contract creation, call execution, and state management.
*/
package vm
...
"github.com/silachain/sila-library/crypto"
...
// and is used by the BLOCKHASH SILA VM op code.
...
// BlockContext provides the SILA VM with auxiliary information. Once provided
...
// TxContext provides the SILA VM with information about a transaction.
...
// abort is used to abort the SILA VM calling operations
abort atomic.Bool
...
// Initialise a new contract and set the code that is to be used by the SILA VM.
...
// When an error was returned by the SILA VM or when setting the creation code

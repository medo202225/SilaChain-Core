...
This file contains the jump tables for all SILA VM forks,
defining the opcode implementations, gas costs, and stack requirements
for each instruction set version.
*/
package vm
...
// JumpTable contains the SILA VM opcodes supported at a given fork.
...
func newLondonInstructionSet() JumpTable {
	...
	enable3198(&instructionSet) // Base fee opcode
	return validate(instructionSet)
}
...
func newBerlinInstructionSet() JumpTable {
	...
	enable2929(&instructionSet) // Gas cost increases for state access opcodes
	return validate(instructionSet)
}

...
This file contains tests for block header verification and gas limit
calculation in the SILA blockchain, including pre-merge and post-merge
scenarios with both Clique and Ethash consensus engines.
*/
package core
...
"github.com/silachain/sila-library/consensus/clique"

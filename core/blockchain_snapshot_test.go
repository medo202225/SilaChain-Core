...
// It can be used for testing that restart SILA normally.
...
// It can be used for testing that restart SILA after the crash.
...
// Tests a SILA restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a SILA was crashed and restarts with a broken snapshot. In this case the
...
// Tests a SILA was crashed and restarts with a broken snapshot. In this case
...
// Tests a SILA was running with snapshot enabled. Then restarts without
...
// Tests the SILA was running with snapshot enabled and resetHead is applied.
...
// Tests the SILA was running with a complete snapshot and then imports a few

...
// 2.1.0 (Model T). The SILA address representation was changed from the 20
...
//go:generate protoc -I/usr/local/include:. --go_out=paths=source_relative:. messages.proto messages-common.proto messages-management.proto messages-sila.proto

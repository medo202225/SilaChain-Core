...
const (
	...
	// SILA Blockchain (formerly Ethereum)
...
const file_messages_proto_rawDesc = "" +
	"\n" +
	"\x0emessages.proto\x12\x12hw.trezor.messages\x1a google/protobuf/descriptor.proto*\x91?\n" +
	"\vMessageType\x12$\n" +
	...
	"\x1cMessageType_SILAGetPublicKey\x10\xc2\x03\x1a\x04\x90\xb5\x18\x01\x12$\n" +
	"\x19MessageType_SILAPublicKey\x10\xc3\x03\x1a\x04\x98\xb5\x18\x01\x12$\n" +
	"\x1aMessageType_SILAGetAddress\x108\x1a\x04\x90\xb5\x18\x01\x12!\n" +
	"\x17MessageType_SILAAddress\x109\x1a\x04\x98\xb5\x18\x01\x12 \n" +
	"\x16MessageType_SILASignTx\x10:\x1a\x04\x90\xb5\x18\x01\x12#\n" +
	"\x19MessageType_SILATxRequest\x10;\x1a\x04\x98\xb5\x18\x01\x12\x1f\n" +
	"\x15MessageType_SILATxAck\x10<\x1a\x04\x90\xb5\x18\x01\x12%\n" +
	"\x1bMessageType_SILASignMessage\x10@\x1a\x04\x90\xb5\x18\x01\x12'\n" +
	"\x1dMessageType_SILAVerifyMessage\x10A\x1a\x04\x90\xb5\x18\x01\x12*\n" +
	" MessageType_SILAMessageSignature\x10B\x1a\x04\x98\xb5\x18\x01\x12#\n" +
	...
	"\vwire_no_fsm\x12!.google.protobuf.EnumValueOptions\x18؆\x03 \x01(\bR\twireNoFsmBw\n" +
	"#com.satoshilabs.trezor.lib.protobufB\rTrezorMessageZAgithub.com/sila-blockchain/sila-library/accounts/usbwallet/trezor"

...
// CallContract executes a SILA contract call with the specified data as the
// input.
...
// PendingCallContract executes a SILA contract call against the pending state.
...
// CallContractAtHash executes a SILA contract call against the state at the specified block hash.

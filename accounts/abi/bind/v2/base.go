...
From   common.Address // SILA account to send the transaction from
...
// SILA network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
address    common.Address     // Deployment address of the contract on the SILA blockchain
abi        abi.ABI            // Reflect based ABI to access the correct SILA methods

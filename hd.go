...
// at m/44'/60'/0'/1, etc.
//
// Note: 60' is the SLIP-44 coin type for SILA (formerly Ethereum's coin type).
// This maintains compatibility with existing hardware wallets.
...
// the `coin_type` 60' (or 0x8000003C) to SILA (formerly Ethereum).
//
// The root path for SILA is m/44'/60'/0'/0 according to the specification

...
"github.com/SILA/sila-chain/crypto/keccak"
)
...
// Address represents the 20 byte address of a SILA account.
...
// Decimal represents a decimal number for JSON marshaling.
type Decimal uint64

func isStringJSON(input []byte) bool {
return len(input) >= 2 && input[0] == '"' && input[len(input)-1] == '"'
}

// UnmarshalJSON parses a decimal number.
func (d *Decimal) UnmarshalJSON(input []byte) error {
if !isStringJSON(input) {
...
// PrettyBytes represents bytes for pretty printing.

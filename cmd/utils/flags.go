...
// Package utils contains internal helper functions for SILA commands.
package utils
...
"github.com/sila-blockchain/sila-library/accounts"
"github.com/sila-blockchain/sila-library/accounts/keystore"
bparams "github.com/sila-blockchain/sila-library/beacon/params"
"github.com/sila-blockchain/sila-library/common"
"github.com/sila-blockchain/sila-library/common/fdlimit"
"github.com/sila-blockchain/sila-library/common/hexutil"
"github.com/sila-blockchain/sila-library/core"
"github.com/sila-blockchain/sila-library/core/rawdb"
"github.com/sila-blockchain/sila-library/core/txpool/blobpool"
"github.com/sila-blockchain/sila-library/core/txpool/legacypool"
"github.com/sila-blockchain/sila-library/core/vm"
"github.com/sila-blockchain/sila-library/crypto"
"github.com/sila-blockchain/sila-library/crypto/kzg4844"
"github.com/sila-blockchain/sila-library/sila"
"github.com/sila-blockchain/sila-library/sila/silaconfig"
"github.com/sila-blockchain/sila-library/sila/filters"
"github.com/sila-blockchain/sila-library/sila/gasprice"
"github.com/sila-blockchain/sila-library/sila/syncer"
"github.com/sila-blockchain/sila-library/sila/tracers"
"github.com/sila-blockchain/sila-library/ethdb"
"github.com/sila-blockchain/sila-library/ethdb/remotedb"
"github.com/sila-blockchain/sila-library/silastats"
"github.com/sila-blockchain/sila-library/graphql"
"github.com/sila-blockchain/sila-library/internal/ethapi"
"github.com/sila-blockchain/sila-library/internal/flags"
"github.com/sila-blockchain/sila-library/log"
"github.com/sila-blockchain/sila-library/metrics"
"github.com/sila-blockchain/sila-library/metrics/exp"
"github.com/sila-blockchain/sila-library/metrics/influxdb"
"github.com/sila-blockchain/sila-library/miner"
"github.com/sila-blockchain/sila-library/node"
"github.com/sila-blockchain/sila-library/p2p"
"github.com/sila-blockchain/sila-library/p2p/enode"
"github.com/sila-blockchain/sila-library/p2p/nat"
"github.com/sila-blockchain/sila-library/p2p/netutil"
"github.com/sila-blockchain/sila-library/params"
"github.com/sila-blockchain/sila-library/rpc"
"github.com/sila-blockchain/sila-library/triedb"
"github.com/sila-blockchain/sila-library/triedb/hashdb"
"github.com/sila-blockchain/sila-library/triedb/pathdb"
...
Value:    silaconfig.Defaults.SyncMode.String(),
...
Value:    silaconfig.Defaults.EnableStateSizeTracking,
Category: flags.StateCategory,
}
StateHistoryFlag = &cli.Uint64Flag{
Name:     "history.state",
Usage:    "Number of recent blocks to retain state history for, only relevant in state.scheme=path (default = 90,000 blocks, 0 = entire chain)",
Value:    silaconfig.Defaults.StateHistory,
Category: flags.StateCategory,
}
...
Value:    silaconfig.Defaults.TrienodeHistory,
Category: flags.StateCategory,
}
...
Value:    uint(silaconfig.Defaults.NodeFullValueCheckpoint),
Category: flags.StateCategory,
}
TransactionHistoryFlag = &cli.Uint64Flag{
Name:     "history.transactions",
Usage:    "Number of recent blocks to maintain transactions index for (default = about one year, 0 = entire chain)",
Value:    silaconfig.Defaults.TransactionHistory,
Category: flags.StateCategory,
}
ChainHistoryFlag = &cli.StringFlag{
Name:     "history.chain",
Usage:    `Blockchain history retention ("all", "postmerge", or "postprague")`,
Value:    silaconfig.Defaults.HistoryMode.String(),
Category: flags.StateCategory,
}
...
Value:    silaconfig.Defaults.LogHistory,
Category: flags.StateCategory,
}
...
Value:    silaconfig.Defaults.TxPool.Journal,
Category: flags.TxPoolCategory,
}
TxPoolRejournalFlag = &cli.DurationFlag{
Name:     "txpool.rejournal",
Usage:    "Time interval to regenerate the local transaction journal",
Value:    silaconfig.Defaults.TxPool.Rejournal,
Category: flags.TxPoolCategory,
}
TxPoolPriceLimitFlag = &cli.Uint64Flag{
Name:     "txpool.pricelimit",
Usage:    "Minimum gas price tip to enforce for acceptance into the pool",
Value:    silaconfig.Defaults.TxPool.PriceLimit,
Category: flags.TxPoolCategory,
}
TxPoolPriceBumpFlag = &cli.Uint64Flag{
Name:     "txpool.pricebump",
Usage:    "Price bump percentage to replace an already existing transaction",
Value:    silaconfig.Defaults.TxPool.PriceBump,
Category: flags.TxPoolCategory,
}
TxPoolAccountSlotsFlag = &cli.Uint64Flag{
Name:     "txpool.accountslots",
Usage:    "Minimum number of executable transaction slots guaranteed per account",
Value:    silaconfig.Defaults.TxPool.AccountSlots,
Category: flags.TxPoolCategory,
}
TxPoolGlobalSlotsFlag = &cli.Uint64Flag{
Name:     "txpool.globalslots",
Usage:    "Maximum number of executable transaction slots for all accounts",
Value:    silaconfig.Defaults.TxPool.GlobalSlots,
Category: flags.TxPoolCategory,
}
TxPoolAccountQueueFlag = &cli.Uint64Flag{
Name:     "txpool.accountqueue",
Usage:    "Maximum number of non-executable transaction slots permitted per account",
Value:    silaconfig.Defaults.TxPool.AccountQueue,
Category: flags.TxPoolCategory,
}
TxPoolGlobalQueueFlag = &cli.Uint64Flag{
Name:     "txpool.globalqueue",
Usage:    "Maximum number of non-executable transaction slots for all accounts",
Value:    silaconfig.Defaults.TxPool.GlobalQueue,
Category: flags.TxPoolCategory,
}
TxPoolLifetimeFlag = &cli.DurationFlag{
Name:     "txpool.lifetime",
Usage:    "Maximum amount of time non-executable transaction are queued",
Value:    silaconfig.Defaults.TxPool.Lifetime,
Category: flags.TxPoolCategory,
}
...
Value:    silaconfig.Defaults.BlobPool.Datadir,
...
Value:    silaconfig.Defaults.BlobPool.Datacap,
Category: flags.BlobPoolCategory,
}
...
Value:    silaconfig.Defaults.BlobPool.PriceBump,
Category: flags.BlobPoolCategory,
}
...
Category: flags.PerfCategory,
Value:    silaconfig.Defaults.FilterLogCacheSize,
}
...
Value:    silaconfig.Defaults.Miner.GasCeil,
Category: flags.MinerCategory,
}
MinerGasPriceFlag = &flags.BigFlag{
Name:     "miner.gasprice",
Usage:    "Minimum gas price for mining a transaction",
Value:    silaconfig.Defaults.Miner.GasPrice,
Category: flags.MinerCategory,
}
...
Value:    silaconfig.Defaults.Miner.Recommit,
Category: flags.MinerCategory,
}
...
Name:     "rpc.gascap",
Usage:    "Sets a cap on gas that can be used in sila_call/estimateGas (0=infinite)",
Value:    silaconfig.Defaults.RPCGasCap,
Category: flags.APICategory,
}
RPCGlobalEVMTimeoutFlag = &cli.DurationFlag{
Name:     "rpc.evmtimeout",
Usage:    "Sets a timeout used for sila_call (0=infinite)",
Value:    silaconfig.Defaults.RPCEVMTimeout,
Category: flags.APICategory,
}
...
Usage:    "Maximum number of alternative addresses or topics allowed per search position in sila_getLogs filter criteria (0 = no cap)",
Value:    silaconfig.Defaults.LogQueryLimit,
Category: flags.APICategory,
}
RPCTxSyncDefaultTimeoutFlag = &cli.DurationFlag{
Name:     "rpc.txsync.defaulttimeout",
Usage:    "Default timeout for sila_sendRawTransactionSync (e.g. 2s, 500ms)",
Value:    silaconfig.Defaults.TxSyncDefaultTimeout,
Category: flags.APICategory,
}
RPCTxSyncMaxTimeoutFlag = &cli.DurationFlag{
Name:     "rpc.txsync.maxtimeout",
Usage:    "Maximum allowed timeout for sila_sendRawTransactionSync (e.g. 5m)",
Value:    silaconfig.Defaults.TxSyncMaxTimeout,
Category: flags.APICategory,
}
RPCGlobalRangeLimitFlag = &cli.Uint64Flag{
Name:     "rpc.rangelimit",
Usage:    "Maximum block range (end - begin) allowed for range queries (0 = unlimited)",
Value:    silaconfig.Defaults.RangeLimit,
Category: flags.APICategory,
}
...
Name:     "silastats",
Usage:    "Reporting URL of a silastats service (nodename:secret@host:port)",
...
Value:    silaconfig.Defaults.SlowBlockThreshold,
Category: flags.LoggingCategory,
}
...
Value:    silaconfig.Defaults.GPO.Blocks,
Category: flags.GasPriceCategory,
}
GpoPercentileFlag = &cli.IntFlag{
Name:     "gpo.percentile",
Usage:    "Suggested gas price is the given percentile of a set of recent transaction gas prices",
Value:    silaconfig.Defaults.GPO.Percentile,
Category: flags.GasPriceCategory,
}
GpoMaxGasPriceFlag = &cli.Int64Flag{
Name:     "gpo.maxprice",
Usage:    "Maximum transaction priority fee (or gasprice before London fork) to be recommended by gpo",
Value:    silaconfig.Defaults.GPO.MaxPrice.Int64(),
Category: flags.GasPriceCategory,
}
GpoIgnoreGasPriceFlag = &cli.Int64Flag{
Name:     "gpo.ignoreprice",
Usage:    "Gas price below which gpo will ignore transactions",
Value:    silaconfig.Defaults.GPO.IgnorePrice.Int64(),
Category: flags.GasPriceCategory,
}
...
// for Sila and returns half of the allowance to assign to the database.
...
silaPeers := cfg.MaxPeers
log.Info("Maximum peer count", "SILA", silaPeers, "total", cfg.MaxPeers)
...
func setRequiredBlocks(ctx *cli.Context, cfg *silaconfig.Config) {
...
cfg.SyncMode = silaconfig.FullSync // dev sync target forces full sync
...
if cfg.TransactionHistory == silaconfig.Defaults.TransactionHistory && cfg.TxLookupLimit != silaconfig.Defaults.TxLookupLimit {
...
if cfg.SyncMode == silaconfig.SnapSync {
...
if ctx.IsSet(NoDiscoverFlag.Name) {
cfg.SilaDiscoveryURLs, cfg.SnapDiscoveryURLs = []string{}, []string{}
} else if ctx.IsSet(DNSDiscoveryFlag.Name) {
urls := ctx.String(DNSDiscoveryFlag.Name)
if urls == "" {
cfg.SilaDiscoveryURLs = []string{}
} else {
cfg.SilaDiscoveryURLs = SplitAndTrim(urls)
}
}
...
// no URLs are set.
func SetDNSDiscoveryDefaults(cfg *silaconfig.Config, genesis common.Hash) {
if cfg.SilaDiscoveryURLs != nil {
return // already set through flags/config
}
protocol := "all"
if url := params.KnownDNSNetwork(genesis, protocol); url != "" {
cfg.SilaDiscoveryURLs = []string{url}
cfg.SnapDiscoveryURLs = cfg.SilaDiscoveryURLs
}
}

// RegisterSilaService adds a Sila client to the stack.
...
func RegisterSilaStatsService(stack *node.Node, backend *sila.SilaAPIBackend, url string) {
if err := silastats.New(stack, backend, backend.Engine(), url); err != nil {
...
func RegisterFilterAPI(stack *node.Node, backend ethapi.Backend, silacfg *silaconfig.Config) *filters.FilterSystem {
filterSystem := filters.NewFilterSystem(backend, filters.Config{
LogCacheSize:  silacfg.FilterLogCacheSize,
LogQueryLimit: silacfg.LogQueryLimit,
RangeLimit:    silacfg.RangeLimit,
})
...
func RegisterSyncOverrideService(stack *node.Node, sila *sila.Sila, target common.Hash, exitWhenSynced bool) {
...
syncer.Register(stack, sila, target, exitWhenSynced)
}
...
// Backwards compatibility with sila < 1.5 which required
// these prefixes.
endpoint = endpoint[4:]
}
...
engine, err := silaconfig.CreateConsensusEngine(config, chainDb)
if err != nil {
Fatalf("%v", err)
}
if gcmode := ctx.String(GCModeFlag.Name); gcmode != "full" && gcmode != "archive" {
...
TrieCleanLimit:          silaconfig.Defaults.TrieCleanCache,
NoPrefetch:              ctx.Bool(CacheNoPrefetchFlag.Name),
TrieDirtyLimit:          silaconfig.Defaults.TrieDirtyCache,
ArchiveMode:             ctx.String(GCModeFlag.Name) == "archive",
TrieTimeLimit:           silaconfig.Defaults.TrieTimeout,
SnapshotLimit:           silaconfig.Defaults.SnapshotCache,
...
SlowBlockThreshold: silaconfig.Defaults.SlowBlockThreshold,
}

...
"github.com/sila-blockchain/sila-library/cmd/svm/internal/t8ntool"
"github.com/sila-blockchain/sila-library/internal/cmdtest"
"github.com/sila-blockchain/sila-library/internal/reexec"
)

func TestMain(m *testing.M) {
// Run the app if we've been exec'd as "silakey-test" in runSilakey.
reexec.Register("svm-test", func() {
...
wantStdout: "./testdata/svmrun/1.out.1.txt",
wantStderr: "./testdata/svmrun/1.out.2.txt",
},
...
wantStdout: "./testdata/svmrun/2.out.1.txt",
wantStderr: "./testdata/svmrun/2.out.2.txt",
},
{ // struct-tracing, plus alloc-dump
input:      []string{"run", "--trace", "--trace.format=struct", "--dump", "0x6040"},
wantStdout: "./testdata/svmrun/3.out.1.txt",
},
{ // json-tracing (default), plus alloc-dump
input:      []string{"run", "--trace", "--dump", "0x6040"},
wantStdout: "./testdata/svmrun/4.out.1.txt",
},
{ // md-tracing
input:      []string{"run", "--trace", "--trace.format=md", "0x6040"},
wantStdout: "./testdata/svmrun/5.out.1.txt",
wantStderr: "./testdata/svmrun/5.out.2.txt",
},
{ // statetest subcommand
input:      []string{"statetest", "./testdata/statetest.json"},
wantStdout: "./testdata/svmrun/6.out.1.txt",
wantStderr: "./testdata/svmrun/6.out.2.txt",
},
{ // statetest subcommand with output
input:      []string{"statetest", "--trace", "--trace.format=md", "./testdata/statetest.json"},
wantStdout: "./testdata/svmrun/7.out.1.txt",
wantStderr: "./testdata/svmrun/7.out.2.txt",
},
{ // statetest subcommand with output
input:      []string{"statetest", "--trace", "--trace.format=json", "./testdata/statetest.json"},
wantStdout: "./testdata/svmrun/8.out.1.txt",
wantStderr: "./testdata/svmrun/8.out.2.txt",
},
} {
tt.Logf("args: go run ./cmd/svm %v\n", strings.Join(tc.input, " "))
tt.Run("svm-test", tc.input...)
...
func TestSvmRunRegEx(t *testing.T) {
t.Parallel()
tt := cmdtest.NewTestCmd(t, nil)
for i, tc := range []struct {
input      []string
...
wantStdout: "./testdata/svmrun/9.out.1.txt",
wantStderr: "./testdata/svmrun/9.out.2.txt",
},
{ // statetest subcommand
input:      []string{"statetest", "--bench", "./testdata/statetest.json"},
wantStdout: "./testdata/svmrun/10.out.1.txt",
wantStderr: "./testdata/svmrun/10.out.2.txt",
},
} {
tt.Logf("args: go run ./cmd/svm %v\n", strings.Join(tc.input, " "))
tt.Run("svm-test", tc.input...)
...
// TestSVMTracing is a test that checks the tracing-output from svm.
func TestSVMTracing(t *testing.T) {
t.Parallel()
tt := cmdtest.NewTestCmd(t, nil)
for i, tc := range []struct {
base           string

...
Name:  "abi",
Usage: "Path to the SILA contract ABI json to bind, - for STDIN",
}
binFlag = &cli.StringFlag{
Name:  "bin",
Usage: "Path to the SILA contract bytecode (generate deploy method)",
}
...
var app = flags.NewApp("SILA ABI wrapper code generator")

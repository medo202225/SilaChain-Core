...
Changed the namespace format to adhere to the legacy SILA format: `name_methodName`. Changes:
...
3.2.0
Make ShowError, OnApprovedTx, OnSignerStartup be json-rpc notifications:

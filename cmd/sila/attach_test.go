...
// TestAttachWithHeaders tests that 'sila attach' with custom headers works, i.e
...
// TestRemoteDbWithHeaders tests that 'sila db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.

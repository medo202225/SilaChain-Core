...
Name:      "wallet",
Usage:     "Manage SILA presale wallets",
ArgsUsage: "",
Description: `
...
Name:      "import",
Usage:     "Import SILA presale wallet",
ArgsUsage: "<keyFile>",
Action:    importWallet,
Flags: []cli.Flag{
utils.DataDirFlag,
...
between sila nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    sila account update [options] <address>
...
Note:
As you can directly copy your encrypted accounts to another sila instance,

...
"github.com/sila-blockchain/sila-library/p2p/enr"
...
func silaFilter(args []string) (nodeFilter, error) {
...
if n.N.Load(enr.WithEntry("sila", &sila)) != nil {
return false
}
return filter(sila.ForkID) == nil
}
return f, nil
}

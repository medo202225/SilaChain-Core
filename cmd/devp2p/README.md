...
Use `devp2p enrdump <base64>` to verify and display a SILA Node Record.
...
- `-sila-network <mainnet/testnet>` filters nodes by "sila" ENR entry
...
3. run the client using the resulting database. For sila, use a command like the one below:
...
Repeat the above process (re-initialising the node) in order to run the Sila Protocol test suite again.


[sila]: https://github.com/sila-blockchain/devp2p/blob/master/caps/sila.md
[dns-tutorial]: https://sila-blockchain.org/docs/developers/sila-developer/dns-discovery-setup
[discv4]: https://github.com/sila-blockchain/devp2p/tree/master/discv4.md
[discv5]: https://github.com/sila-blockchain/devp2p/tree/master/discv5/discv5.md

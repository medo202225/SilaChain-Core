...
"github.com/sila-blockchain/sila-library/core/forkid"
...
// GetHeaders returns the headers base on an silaGetPacketHeadersPacket.
func (c *Chain) GetHeaders(req *sila.GetBlockHeadersPacket) ([]*types.Header, error) {
if req.Amount < 1 {

...
silakey is a simple command-line tool for working with SILA keyfiles.
...
### `silakey signmessage <keyfile> <message/file>`
...
### `silakey verifymessage <address> <signature> <message/file>`
...
### `silakey changepassword <keyfile>`

...
"github.com/sila-blockchain/sila-library/core/stateless"
...
// Parse block number (nil means "latest" in silaclient).
...
// Connect to the node.
client, err := silaclient.DialContext(ctx, *rpcURL)
if err != nil {
...
// Returns nil for "latest" (silaclient convention for the head block).

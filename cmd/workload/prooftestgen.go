...
"github.com/sila-blockchain/sila-library/eth/tracers"
"github.com/sila-blockchain/sila-library/eth/tracers/native"
"github.com/sila-blockchain/sila-library/internal/flags"
"github.com/sila-blockchain/sila-library/internal/testrand"
...
ret, err := cli.Sila.TraceTransaction(context.Background(), tx.Hash(), &tracers.TraceConfig{
Tracer:       &tracer,
...
res, err := client.Sila.GetProof(ctx, test.Addresses[i][j], test.StorageKeys[i][j], big.NewInt(int64(blockNumber)))
if err != nil {

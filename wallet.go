...
// Derive sends a derivation request to the USB device and returns the SILA
...
// Retrieve the next derived SILA account
...
// chain state reader.
func (w *wallet) SelfDerive(bases []accounts.DerivationPath, chain sila.ChainStateReader) {
w.stateLock.Lock()
defer w.stateLock.Unlock()

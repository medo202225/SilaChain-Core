...
ctypes "github.com/sila-blockchain/sila-library/core/types"
)
...
// together with a proof through a SILA beacon header and corresponding state.
...
// https://github.com/sila-blockchain/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientupdate
...
// HeaderWithExecProof contains a SILA beacon header and proves the belonging execution
...
//
// See data structure definition here:
// https://github.com/sila-blockchain/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientfinalityupdate
...
// latest accepted head of the SILA beacon chain, along with the hash of the latest

...
// Package types implements a few types of the SILA beacon chain for light client usage.
package types
...
"github.com/sila-blockchain/sila-library/beacon/merkle"
...
// Header defines a SILA beacon header.
//
// See data structure definition here:
// https://github.com/sila-blockchain/consensus-specs/blob/dev/specs/phase0/beacon-chain.md#beaconblockheader
type Header struct {
...
// SSZ hash of the beacon state (https://github.com/sila-blockchain/consensus-specs/blob/dev/specs/bellatrix/beacon-chain.md#beacon-state)
StateRoot common.Hash `gencodec:"required" json:"state_root"`

// SSZ hash of the beacon block body (https://github.com/sila-blockchain/consensus-specs/blob/dev/specs/bellatrix/beacon-chain.md#beaconblockbody)
...
// SignedHeader represents a SILA beacon header signed by a sync committee.
//
// This structure is created from either an optimistic update or an instant update:
//   - https://github.com/sila-blockchain/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientoptimisticupdate
//   - https://github.com/sila-blockchain/beacon-APIs/blob/instant_update/apis/beacon/light_client/instant_update.yaml
